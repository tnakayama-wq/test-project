...
const DIS={"1":'※査定賃料は2026年4月6日付ハウジングセンター（株）家賃査定報告に基づく当社査定であり、実際の賃料改定は賃借人との個別協議によります。NOIは（年間賃料（税込）−管理費等−固定資産税等）÷（販売価格（税込）＋購入一時金）で算出。固定資産税等は想定額であり正式な額ではありません。管理費・修繕積立金・駐車場・看板料等は最終確定前のため変更となる場合があります。表面利回りは経費控除前（年間賃料（税別）÷販売価格（税込））。別途、管理費等 月123,080円・固定資産税等（想定）年650,200円および取得時諸費用が必要です。価格・条件は予告なく変更される場合があり、最終条件は売買契約書によります。本物件は共同住宅を含む一棟の建物の一部（区分所有）です。管理規約上の用途制限、一部共用部分の負担区分等は別途資料にてご確認ください。',"2":'※査定賃料は2026年4月6日付ハウジングセンター（株）家賃査定報告に基づく当社査定であり、実際の賃料改定は賃借人との個別協議によります。NOIは（年間賃料（税込）−管理費等−固定資産税等）÷（販売価格（税込）＋購入一時金）で算出。固定資産税等は想定額であり正式な額ではありません。管理費・修繕積立金・駐車場・看板料等は最終確定前のため変更となる場合があります。表面利回りは経費控除前（年間賃料（税別）÷販売価格（税込））。別途、管理費等 月170,680円・固定資産税等（想定）年834,400円および取得時諸費用が必要です。価格・条件は予告なく変更される場合があり、最終条件は売買契約書によります。本物件は共同住宅を含む一棟の建物の一部（区分所有）です。管理規約上の用途制限、一部共用部分の負担区分等は別途資料にてご確認ください。'};

const FLOORS = [
 { f:"1", kind:"店舗一括", zumen:"ph_zumen_1f.png", no:"SNK-1F-2608",
   price:"2億7,996", noi:"4.66", gross:"4.97", cnoi:"3.41", cgross:"3.83", dep:"3,484,800円",
   area:"311.57㎡・94.25坪", tsubo:"297.0万円",
 ...
 { f:"2", kind:"事務所一括", zumen:"ph_zumen_2f.png", no:"SNK-2F-2608",
   price:"3億4,796", noi:"4.96", gross:"5.34", cnoi:"3.56", cgross:"4.04", dep:"5,613,000円",
   area:"432.06㎡・130.70坪", tsubo:"266.2万円",
...
FLOORS.forEach(F=>{
  ...
  const spec=[[["専有面積",F.area],["坪単価",F.tsubo],["購入一時金",F.dep]],
  ...
  // ── 訴求・免責 ──
  s.addShape(pres.ShapeType.rect,{x:RX,y:FY,w:0.04,h:0.42,fill:{color:C.SEAL},line:{width:0}});
  txt(s,F.pitch,RX+0.13,FY,RW-0.13,0.42,{fontSize:12,lineSpacing:17});
  txt(s,DIS[F.f],RX,FY+0.45,RW,0.58,{fontSize:5,color:C.MUTE,lineSpacing:7,wrap:true,shrinkText:false});
